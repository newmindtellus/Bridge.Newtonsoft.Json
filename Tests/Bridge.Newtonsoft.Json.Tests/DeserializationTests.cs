...
namespace Bridge.Newtonsoft.Json.Tests
{
    ...
    public class DeserializationTests
    {
        ...
        public static void DateTimeWorks()
        {
            ...
            DateTime jsonDt = JsonConvert.DeserializeObject<DateTime>("\"2010-06-10T09:00:00.000\"");
        ...
        public static void ComplexArrayWorks()
        {
            ...
            Assert.AreEqual("Bridge.Newtonsoft.Json.Tests.DeserializationTests+Class1[]", deserialized.GetType().FullName, "#2");

...
namespace Bridge.Newtonsoft.Json.Tests.Issues
{
    ...
    public class Bridge1438
    {
        ...
        public static void TestJSONParse()
        {
            ...
            Assert.AreEqual("Bridge.Newtonsoft.Json.Tests.Issues.Bridge1438+Foo", result.GetType().FullName, "Check result type name");
        ...
        public static void TestJSONParseAsArray()
        {
            ...
            Assert.AreEqual("Bridge.Newtonsoft.Json.Tests.Issues.Bridge1438+Foo", result[0].GetType().FullName, "Check result[0] type name");
